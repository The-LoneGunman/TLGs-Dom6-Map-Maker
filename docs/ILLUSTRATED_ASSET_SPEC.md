...
Reviewed September 22, 2026. The package version remains 0.1.5. Its published `581b2b8` build includes the four material textures; connected regions, procedural realm painters and the optional illustrated game exporter described below are newer source work. See [Versions and documentation](../README.md#versions-and-documentation).
