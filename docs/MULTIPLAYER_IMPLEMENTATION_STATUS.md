...
Reviewed September 20, 2026. This document covers the development branch **`codex/full-implementation-round-sep20`**, based on merged `main` revision `958e545`. This implementation round has not been merged, deployed to the hosted app, or included in a Windows release. See [Versions and documentation](../README.md#versions-and-documentation).
...
## Implemented in the development round
...
- Final review, merge, hosted deployment, and a separately built/tested Windows release for this round.
